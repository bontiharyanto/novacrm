...
export function AccountSwitcher({
  ...
  return (
    <div className="px-3 py-2">
      <p className="px-1 pb-1.5 text-[10px] font-medium uppercase tracking-[0.16em] text-zinc-500">{t.common.account}</p>
      <label className="relative flex items-center gap-2 rounded-md border border-zinc-800 bg-zinc-900 px-2 py-1.5 transition-colors hover:border-zinc-700">
        ...
        <select
          ...
          className={cn(
            'min-w-0 flex-1 appearance-none bg-transparent pr-5 text-[13px] text-zinc-50 outline-none',
            pending && 'opacity-60',
          )}
