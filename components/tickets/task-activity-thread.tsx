  ...
  return (
    <div className="mt-3 rounded-lg border border-zinc-800 bg-zinc-950/50 p-3 sm:col-span-7">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        <Select value={kindFilter} onChange={(event) => setKindFilter(event.target.value as typeof kindFilter)} className="h-8 w-auto min-w-32 !px-2 !py-0 text-[11px] !leading-5">
        ...
        <Select value={visibilityFilter} onChange={(event) => setVisibilityFilter(event.target.value as typeof visibilityFilter)} className="h-8 w-auto min-w-28 !px-2 !py-0 text-[11px] !leading-5">
        ...
        <Select value={activityWindow} onChange={(event) => setActivityWindow(event.target.value as typeof activityWindow)} className="h-8 w-auto min-w-24 !px-2 !py-0 text-[11px] !leading-5">
